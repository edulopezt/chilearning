...
| 0.3 ✅ | L | Coolify en VPS + deploy staging desde `main` + SSL | Plan §7 | **Hecho 2026-07-15:** app en Coolify (Dockerfile), backend en Supabase cloud (migraciones+seeds+Auth Hook), DNS chilearning.cl → VPS, SSL Let's Encrypt. Login verificado en https://seminarea.chilearning.cl |
